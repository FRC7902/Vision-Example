...
public class IntakeSubsystem extends SubsystemBase {
    ...
    public Command outtakeCommand(boolean isSim) {
        ...
        ElevatorArmPosition m_elvArmPosition = ElevatorArm.getElevatorArmEnumPosition();

        if (isSim) {
            return run(() -> outtake()).withTimeout(IntakeConstants.kIntakeOuttakeTimeoutSec).andThen(() -> stopMotor());
        }
        
        else if (m_elvArmPosition == ElevatorArmPosition.ALGAE_LOW || m_elvArmPosition == ElevatorArmPosition.ALGAE_HIGH) {
    ...
    public Command intakeCommand(boolean isSim) {
        ...
        ElevatorArmPosition m_elvArm = ElevatorArm.getElevatorArmEnumPosition();

        if (isSim && m_elvArm == ElevatorArmPosition.ALGAE_LOW || m_elvArm == ElevatorArmPosition.ALGAE_HIGH) {
        ...
        else if (m_elvArm == ElevatorArmPosition.ALGAE_LOW || m_elvArm == ElevatorArmPosition.ALGAE_HIGH) {
